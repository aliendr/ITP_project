...
<div id="main">
  ...
  <div id="main_button_box">
    <div id="enter_inputs_box">
      <input type="email" class="enter_inputs" id="enter_login" placeholder="email">
    ...
    <div id="reg_inputs_box">
      ...
      <input type="email" class="reg_inputs" id="reg_login" placeholder="email">
  ...
  <div id="more_box">Learn more</div>
</div>
</body>
</html>
